...
export default function AddPordect({categorys, getProdects}) {
        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className="mb-3">
                ...
                <select className="form-select form-select-lg" onChange={(e) => setCid(e.target.value)}>
          ...
          <div className="modal-footer">
            <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={addProdect}>
              הוסף מוצר
            </button>
            <button
              type="button"
