...
export default function Orders({table, orders, getOrders, prodects, totalBill}) { 
...
<div className="row">
<div className="col-5">
  <Menu tid={table._id} prodects={prodects} getOrders={getOrders} totalBill={totalBill}/>
</div>
          ...
          <li className="list-group-item" key={order._id}>
            <div className="row">
              ...
              <div className="col-2 text-center">
                {
                  new Intl.NumberFormat('he-HE', { style: 'currency', currency: 'ILS' }).format(
                    prodectInfo("price", order.pid)
                  )
                }
              </div>
              <div className="col-3 d-flex justify-content-end">
                <button
                  ...
                  data-bs-toggle="modal" data-bs-target="#canselOrderModel"
                >
...
<CanselOrder prodects={prodects} order={currntOrder} getOrders={getOrders} totalBill={totalBill} /> 
</div>
)
