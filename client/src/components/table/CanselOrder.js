...
export default function CanselOrder({ products, order, getOrders, totalBill }) {
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">בטל הזמנה</h5>
            <button
              type="button"
              className="btn-close"
          ...
          <div className="modal-body">
            ...
            {order
              ? products.find((product) => product._id === order.pid).title
              : null}
            "
          </div>
