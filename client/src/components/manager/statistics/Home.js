...
export default function Home({ tables, orders, products }) {
  ...
  function reducePay() {
    ...
    switch (paymantDisplay) {
      case "today":
        tables
          .filter((tab) => Date.parse(tab.updatedAt) >= Date.parse(today))
          .map((table) => {
      ...
      case "week":
        tables
          .filter(
            (tab) =>
              Date.parse(tab.updatedAt) > Date.parse(weekStart) &&
              Date.parse(tab.updatedAt) < Date.parse(weekEnd)
          )
          .map((table) => {
            return (totalPayment += table.pay);
          });
      ...
      case "month":
        tables
          .filter(
            (tab) =>
              Date.parse(tab.updatedAt) > Date.parse(monthStart) &&
              Date.parse(tab.updatedAt) < Date.parse(monthEnd)
          )
          .map((table) => {
            return (totalPayment += table.pay);
          });
      ...
      case "year":
        tables
          .filter(
            (tab) =>
              Date.parse(tab.updatedAt) > Date.parse(yearStart) &&
              Date.parse(tab.updatedAt) < Date.parse(yearEnd)
          )
          .map((table) => {
            return (totalPayment += table.pay);
          });
    ...
    switch (canselsDisplay) {
      case "today":
        orders
          .filter(
            (ord) =>
              ord.cansel === 1 && Date.parse(ord.updatedAt) >= Date.parse(today)
          )
          .map((order) => {
            return (totalCansels += Number(productInfo("price", order.pid)));
          });
        break;
      case "week":
        orders
          .filter(
            (ord) =>
              ord.cansel === 1 &&
              Date.parse(ord.updatedAt) > Date.parse(weekStart) &&
              Date.parse(ord.updatedAt) < Date.parse(weekEnd)
          )
          .map((order) => {
            return (totalCansels += Number(productInfo("price", order.pid)));
          });
      ...
      case "month":
        orders
          .filter(
            (ord) =>
              ord.cansel === 1 &&
              Date.parse(ord.updatedAt) > Date.parse(monthStart) &&
              Date.parse(ord.updatedAt) < Date.parse(monthEnd)
          )
          .map((order) => {
            return (totalCansels += Number(productInfo("price", order.pid)));
          });
      ...
      case "year":
        orders
          .filter(
            (ord) =>
              ord.cansel === 1 &&
              Date.parse(ord.updatedAt) > Date.parse(yearStart) &&
              Date.parse(ord.updatedAt) < Date.parse(yearEnd)
          )
          .map((order) => {
            return (totalCansels += Number(productInfo("price", order.pid)));
          });
                ...
                <div className="btn-group btn-group-sm">
                  <button
                    className={`btn btn-primary ${
                      paymantDisplay === "today" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      paymantDisplay === "week" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      paymantDisplay === "month" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      paymantDisplay === "year" ? "active" : null
                    }`}
            ...
            <div className="card">
              <div className="card-header">
                <div className="btn-group btn-group-sm">
                  <button
                    className={`btn btn-primary ${
                      discountDisplay === "today" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      discountDisplay === "week" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      discountDisplay === "month" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      discountDisplay === "year" ? "active" : null
                    }`}
            ...
            <div className="card">
              <div className="card-header">
                <div className="btn-group btn-group-sm">
                  <button
                    className={`btn btn-primary ${
                      canselsDisplay === "today" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      canselsDisplay === "week" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      canselsDisplay === "month" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      canselsDisplay === "year" ? "active" : null
                    }`}
            ...
            <div className="card">
              <div className="card-header">
                <div className="btn-group btn-group-sm">
                  <button
                    className={`btn btn-primary ${
                      tablesDisplay === "today" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      tablesDisplay === "week" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      tablesDisplay === "month" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      tablesDisplay === "year" ? "active" : null
                    }`}
            ...
            <div className="card">
              <div className="card-header">
                <div className="btn-group btn-group-sm">
                  <button
                    className={`btn btn-primary ${
                      peopleDisplay === "today" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      peopleDisplay === "week" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      peopleDisplay === "month" ? "active" : null
                    }`}
                  ...
                  <button
                    className={`btn btn-primary ${
                      peopleDisplay === "year" ? "active" : null
                    }`}
