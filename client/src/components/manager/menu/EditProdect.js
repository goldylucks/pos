...
export default function EditCategory({categorys, prodect, getProdects}) {
  ...
  useEffect(() => {
    setTitle(prodect.title);
    setCid(prodect.cid);
    setPrice(prodect.price);
  }, [prodect]);
    ...
    <div className="modal-dialog modal-dialog-centered">
      <div className="modal-content">
        ...
        <div className="modal-footer">
          <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={editProdcet}>
            שמור
          </button>
          <button
            type="button"
