...
export default function Table() {
  ...
  function totalBill() {
    ...
    orders
      ...
      .map((order) => {
        const thisPrice = productInfo("price", order.pid);
        total += Number(thisPrice);
      });

    Axios.post("/tables/totalPrice", { id: table._id, total: total }).then(
      () => {
        getTables();
      }
    );
      ...
      <div className="card min-vh-100">
        ...
        <div className="card-body">
          ...
          <div className="tab-content" id="header-tab-tabContent">
            ...
            >
              <Bill table={table} products={products} orders={orders} />
            </div>
